...
#if u like my code please late this# :) 
#code by alireza adavi is_mr18ali
#git hub ==> https://github.com/mr18ali
...
print("site to type or past /    exp:==>  *thiswebsite.com*   /")
print("this code will open u google so u need to open in small window :)")
#CHIZ
try:
        ...
        'adm/','account.asp','admin/account.asp','admin/index.asp','admin/login.asp',
        ...
        'moderator/login.html','moderator/admin.html','admin-ajax.php','wp-sitemap.xml',
        'sitemap.xml','account.html','controlpanel.html','admincontrol.html','admin_login.html',
        ...
        'webadmin.html','administration','pages/admin/admin-login.html','admin/admin-login.html',
        ...
        'administratorlogin.php','adm/','admin/account.cfm','admin/index.cfm','admin/login.cfm',
        ...
        'admin.html','admin/cp.html','cp.html','adminpanel.cfm','moderator.html',
        'administrator/index.html','administrator/login.html','user.html','administrator/account.html',
        'administrator.html','login.html','modelsearch/login.html',
        'moderator/login.html','adminarea/login.html','panel-administracion/index.html',
        'panel-administracion/admin.html','modelsearch/index.html','modelsearch/admin.html',
        ...
        'usuarios/login.cfm','cpadmin.php','cpanl.admin.php','myadmin.php','meadmin.html','admin98.html',
        'admins.php','admin/cp.php',
        ...
        'admin2.aspx','admin2/login.aspx',
        'admin2/index.aspx','usuarios/login.aspx',
        ...
        'adm/','admin/account.js','admin/index.js','admin/login.js','admin/admin.js','admin/account.js',
        ...
        'bb-admin/index.cgi','bb-admin/login.cgi','bb-admin/admin.cgi',
        'admin/home.cgi','admin_area/login.html','admin_area/index.html','/users/sign_in',
        ...
        'siteadmin/index.brf','siteadmin/login.html','admin/account.html','admin/index.html',
        'admin/login.html','admin/admin.html',
        ...
        'moderator/login.brf','moderator/admin.brf','account.brf','pages/admin/admin-login.html',
        'admin/admin-login.html','admin-login.html',
        'controlpanel.brf','admincontrol.brf','admin/adminLogin.html','adminLogin.html',
        'admin/adminLogin.html','home.html','rcjakar/admin/login.brf','adminarea/index.html',
        'adminarea/admin.html',
        'webadmin.brf','webadmin/index.brf','webadmin/admin.brf','admin/controlpanel.html',
        'admin.html','admin/cp.html','cp.html','adminpanel.brf',
        ...
        'adm/index.html','adm.html','moderator/admin.html','user.brf','account.html','controlpanel.html',
        'admincontrol.html','panel-administracion/login.brf','wp-login.brf','adminLogin.brf',
        'admin/adminLogin.brf','home.brf','admin.brf','adminarea/index.brf','adminarea/admin.brf',
        'adminarea/login.brf','panel-administracion/index.brf','panel-administracion/admin.brf',
        'modelsearch/index.brf','modelsearch/admin.brf','admincontrol/login.brf','adm/admloginuser.brf',
        'admloginuser.brf',
        'admin2.brf','admin2/login.brf','admin2/index.brf','usuarios/login.brf','adm/index.brf','adm.brf',
        'affiliate.brf','adm_auth.brf',
        'memberadmin.brf','administratorlogin.brf','cpanel','cpanel.php','cpanel.html','cp.admin.ir.html']
        for i in patch:
            link = "http://" + target + "/" + i
